...
- (id)initWithNibName:(NSString *)nibName bundle:(NSBundle *)nibBundle
{
    ...
    if (self) {
        self.title = NSLocalizedString(@"QuestsActiveTitleKey",@"");
        self.tabBarItem.image = [UIImage imageNamed:@"quest.png"];
        self.tabBarItem.title = NSLocalizedString(@"QuestViewTitleKey",@"");
        activeSort = 1;
		cellsLoaded = 0;
		self.isLink = NO;
...
- (void)viewDidLoad {
   ...
   rightBar = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"questsComplete"] style:UIBarButtonItemStylePlain target:self action:@selector(questButtonTouch:)];
    rightBar.tag = 0;
...
-(void)questButtonTouch:(UIBarButtonItem *)sender{
    ...
    if(sender.tag == 1) {
        sender.image = [UIImage imageNamed:@"questsActive"];
        self.title = NSLocalizedString(@"QuestsCompleteTitleKey",@"");
        self.tabBarItem.title = NSLocalizedString(@"QuestViewTitleKey",@"");

    }
    else {
        sender.image = [UIImage imageNamed:@"questsComplete"];
        self.title = NSLocalizedString(@"QuestsActiveTitleKey",@"");
        self.tabBarItem.title = NSLocalizedString(@"QuestViewTitleKey",@"");
