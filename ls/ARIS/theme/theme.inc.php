...
function page_footer() {
	...
	echo "
	<a href = '$GLOBALS[WWW_ROOT]/apps/log/index.php'><img src = '$GLOBALS[WWW_ROOT]/apps/log/icon.png' width = '50px'/></a>
	<a href = '$GLOBALS[WWW_ROOT]/apps/im/index.php'><img src = '$GLOBALS[WWW_ROOT]/apps/im/icon.png' width = '50px'/></a>
	<a href = '$GLOBALS[WWW_ROOT]/get_location_combined.php'><img src = '$GLOBALS[WWW_ROOT]/apps/map/icon.png' width = '50px'/></a>
	<a href = '$GLOBALS[WWW_ROOT]/apps/inventory/index.php'><img src = '$GLOBALS[WWW_ROOT]/apps/inventory/icon.png' width = '50px'/></a>
